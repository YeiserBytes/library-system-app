...
export interface ApiBookBook extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    available_copies: Schema.Attribute.Integer &
      Schema.Attribute.Required &
    ...
    book_status: Schema.Attribute.Enumeration<
      ['available', 'borrowed', 'reserved', 'inactive']
    >;
    ...
    title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    total_copies: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
...
export interface ApiLoanLoan extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    condition_at_loan: Schema.Attribute.Enumeration<
      ['excellent', 'good', 'fair', 'poor']
    >;
    condition_at_return: Schema.Attribute.Enumeration<
      ['excellent', 'good', 'fair', 'poor']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    due_date: Schema.Attribute.DateTime & Schema.Attribute.Required;
    loan_date: Schema.Attribute.DateTime & Schema.Attribute.Required;
    loan_status: Schema.Attribute.Enumeration<
      ['pending', 'returned', 'overdue', 'active']
    > &
      Schema.Attribute.Required &
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    renewal_count: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
...
export interface ApiReservationReservation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    expiration_date: Schema.Attribute.DateTime & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::reservation.reservation'
...
export interface ApiSettingSetting extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    setting_type: Schema.Attribute.Enumeration<['number', 'string', 'boolean']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    loans: Schema.Attribute.Relation<'oneToMany', 'api::loan.loan'>;
    loans_approved: Schema.Attribute.Relation<'oneToMany', 'api::loan.loan'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'plugin::users-permissions.user'
