...
export interface ApiBookReturnBookReturn extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    late_fee: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
...
export interface ApiBookBook extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    book_state: Schema.Attribute.Enumeration<
      ['Disponible', 'Prestado', 'Reservado', 'Inactivo']
    > &
...
export interface ApiLoanLoan extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    loan_state: Schema.Attribute.Enumeration<
