        ...
        <CardContent>
          <ResponsiveContainer width="100%" height={300}>
            <LineChart data={monthlyData}>
              ...
              />
              <Line type="monotone" dataKey="prestamos" stroke="hsl(var(--primary))" strokeWidth={2} name="Préstamos" />
              <Line
                type="monotone"
        ...
        <CardContent>
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={categoryData}>
              ...
              />
              <Bar dataKey="count" fill="hsl(var(--primary))" radius={[8, 8, 0, 0]} name="Préstamos" />
            </BarChart>
          </ResponsiveContainer>
        </CardContent>
      </Card>
